package com.upc.pe.backend.shared.interfaces.rest.support;

import com.upc.pe.backend.shared.interfaces.rest.resources.MessageResource;
 ...
 */
public abstract class AutoMatchScopedExceptionHandlerSupport {

    private static final Logger log = LoggerFactory.getLogger(AutoMatchScopedExceptionHandlerSupport.class);
