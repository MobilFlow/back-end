package com.upc.pe.backend.iam.application.internal.eventhandlers;

import com.upc.pe.backend.iam.domain.model.commands.SeedRolesCommand;
import com.upc.pe.backend.iam.domain.services.RoleCommandService;
 ...
 * and seed the roles in the database when the application is ready.
 */
@Service
